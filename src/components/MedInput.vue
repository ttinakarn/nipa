    ...
    calsosscore() {
      ...
      if (this.description == "temp") {
        if (this.value == null || this.value === "") {
          ...
          } else if(this.value >= this.sos[1].min && this.value <= this.sos[1].max){
            this.$store.commit("setsostemp", this.sos[1].score)
          } else if(this.value >= this.sos[2].min && this.value <= this.sos[2].max){
            this.$store.commit("setsostemp", this.sos[2].score)
          } else if(this.value >= this.sos[3].min && this.value <= this.sos[3].max){
        ...
        if (this.value == null || this.value === "") {
          ...
          } else if(this.value >= parseInt(this.sos[6].min) && this.value <= parseInt(this.sos[6].max)){
            this.$store.commit("setsospulse", this.sos[6].score)
          } else if(this.value >= parseInt(this.sos[7].min) && this.value <= parseInt(this.sos[7].max)){
            this.$store.commit("setsospulse", this.sos[7].score)
          } else if(this.value >= parseInt(this.sos[8].min) && this.value <= parseInt(this.sos[8].max)){
            this.$store.commit("setsospulse", this.sos[8].score)
          } else if(this.value >= parseInt(this.sos[9].min) && this.value <= parseInt(this.sos[9].max)){
        ...
        if (this.value == null || this.value === "") {
          ...
          } else if(this.value >= parseInt(this.sos[18].min) && this.value <= parseInt(this.sos[18].max)){
            this.$store.commit("setsosresp", this.sos[18].score)
          } else if(this.value >= parseInt(this.sos[19].min) && this.value <= parseInt(this.sos[19].max)){
            this.$store.commit("setsosresp", this.sos[19].score)
          } else if(this.value >= parseInt(this.sos[20].min) && this.value <= parseInt(this.sos[20].max)){
        ...
        if (this.value == null || this.value === "") {
          ...
          } else if(this.value >= parseInt(this.sos[12].min) && this.value <= parseInt(this.sos[12].max)){
            this.$store.commit("setsossbp", this.sos[12].score)
          } else if(this.value >= parseInt(this.sos[13].min) && this.value <= parseInt(this.sos[13].max)){
            this.$store.commit("setsossbp", this.sos[13].score)
          } else if(this.value >= parseInt(this.sos[14].min) && this.value <= parseInt(this.sos[14].max)){
            this.$store.commit("setsossbp", this.sos[14].score)
          } else if(this.value >= parseInt(this.sos[15].min) && this.value <= parseInt(this.sos[15].max)){
